 ...
 * <pre>
 *    Author: houruhou
 *    CreatAt: 19:48/2019-08-26
 *    Desc:
 * </pre>
 */

public class HeartRateNewDayLineChartFormatter implements IAxisValueFormatter {
    private static final String TAG = "HeartRateNewDayLineChar";
    static long ONE_HOUR = TimeUnit.HOURS.toMillis(1);
    @Override
